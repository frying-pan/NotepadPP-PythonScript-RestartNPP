...
class C_Get_NPPScintilla_Wins():
	...
	# return tuple : (npp_win_hwnd, [scint_win_hwnd_1, scint_win_hwnd_2, ...], s_npp_class, s_scint_class)
	# (the first 2 Scintilla handles *should* be the 2 views/editors window in the [editor1, editor2, ...] order)
